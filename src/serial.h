...
namespace riku
{
    class Serial
    {
            ...
            int ReadTTY_inner ( void * buffer, int sizeBuffer, unsigned timeout = 50, std::string const& dev = "???");
        ...
        public:
            ...
            int ReadTTY ( void * buffer, int sizeBuffer, unsigned timeout = 50, std::string const& dev = "???");
